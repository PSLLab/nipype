...
class FNIRTInputSpec(FSLCommandInputSpec):
    ...
    modulatedref_file = traits.Either(traits.Bool, File,
                                      argstr='--refout=%s', name_template='%s_modref', name_source=['in_file'],
    ...
    out_intensitymap_file = traits.Either(traits.Bool, File,
                                          argstr='--intout=%s', name_source=['in_file'], name_template='%s_intensmap',
                                          desc='name of files for writing information pertaining '
                                          'to intensity mapping', hash_files=False)
    log_file = File(argstr='--logout=%s', keep_extension=True,
                    desc='Name of log-file', name_source=['in_file'], name_template='%s_fnirt.log', hash_files=False)
